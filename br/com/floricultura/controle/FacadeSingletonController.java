...
import br.com.floricultura.observer.LogEstoqueObserver;
import br.com.floricultura.observer.NotificacaoEstoqueBaixoObserver;
...
import br.com.floricultura.repositorio.RepositorioProdutoProxy;
...
public class FacadeSingletonController {
    ...
    public void inicializarRepositorios(boolean usarMemoria) {
        ...
        // Padrão Proxy: envolve o repositório real em um proxy de proteção
        RepositorioProdutoProxy proxyProduto = new RepositorioProdutoProxy(factory.criarRepositorioProduto());
        gerProduto = new GerenciamentoDeProduto(proxyProduto);

        // Padrão Observer: registra os observadores de estoque
        gerProduto.adicionarObservador(new LogEstoqueObserver());
        gerProduto.adicionarObservador(new NotificacaoEstoqueBaixoObserver());
